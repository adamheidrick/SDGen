...
Alignment = [
    {
        "Chaotic": "You align yourself with destruction, ambition, and wickedness. Survival of the fittest."
    },
    {
...
Deities = [
    {
        "Saint Terragnis (Lawful)": "A legendary knight who is the patron of most lawful humans. She ascended to "
...
Titles = {
    "Fighter": {"Lawful": "Squire", "Chaotic": "Knave", "Neutral": "Warrior"},
